...
<div class="col-lg-8">
    <form method="post" action="/dashboard/product/{{ $product->slug }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            @if ($product->image)
            <img class="img-preview img-fluid mb-3 col-sm-5 rounded-2 d-block" src="{{ asset('storage/' . $product->image) }}" alt="">
            @else
            <img class="img-preview img-fluid mb-3 col-sm-5 rounded-2">
            @endif
